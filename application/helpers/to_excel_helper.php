...
if (!function_exists('download_excel')) {
    ...
    function download_excel($data = null, $filename = 'report.xlsx', $fields = array()) {
        $spreadsheet = new Spreadsheet();
        //Specify the properties for this document
        $spreadsheet->getProperties()
                ->setTitle('VHMS Reports')
                ->setSubject('Reports')
                ->setDescription('Generated by VHMS application')
                ->setCreator('ayushsoftwares.com')
                ->setLastModifiedBy('ayushsoftwares.com');
