...
class Layout {
    ...
    //set the layout path
    public $layoutsFolder = 'layout/default';
    public $errorLayoutsFolder = 'errors/app_error/';
    //set page the title
    public $title = '';
    public $menuFlag = true;
    public $headerFlag = true;
    public $headerBlank = FALSE;
    public $footerFlag = true;
    public $navTitleFlag = FALSE;
    public $navIcon = 'fa fa-dashboard';
    public $navDescr = '';
    public $navTitle = '';
    public $homeLayout = '';
    public $headText = '';
    public $footText = '';
    public $homeLink = ''; // home page link
    var $obj;
    public $param;
    ...
    public function __get($name) {
        ...
        if (is_array($this->param) && array_key_exists($name, $this->param)) {
