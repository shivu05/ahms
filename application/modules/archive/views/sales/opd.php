<div class="row">
    <div class="col-md-12">
        <div class="box box-primary">
            <div class="box-header with-border"><h3 class="box-title"><i class="fa fa-archive"></i> Archived Pharmacy OPD report:</h3></div>
            <div class="box-body">
                <?php echo $top_form; ?>
...
<script type="text/javascript">
    $(document).ready(function () {
        $('#search_form').on('click', '#search', function () {
            ...
            $.ajax({
                type: "POST",
                url: base_url + 'archive/sales/get_pharmacy_report',
                data: form_data,
                dataType: 'html',
