    ...
    <div class="col-md-12">
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title"><i class="fa fa-archive" aria-hidden="true"></i> Archived Monthly OPD IPD Report</h3>
...
<script type="text/javascript">
    $(document).ready(function () {
        $('#search_form').on('change', '#arch_year', function () {
            ...
            if (arch_year !== '') {
                $.ajax({
                    url: base_url + 'archive/Ipd/monthly_io_report',
                    type: 'POST',
                    dataType: 'html',
        ...
        $('#export_to_pdf').on('click', function (e) {
            ...
            window.open(base_url + 'archive/Ipd/monthly_ipd_opd_report_pdf/' + arch_year);
        });
    });
</script>