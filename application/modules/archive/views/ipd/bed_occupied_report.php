<div class="row">
    <div class="col-md-12">
        <div class="box">
            <div class="box-header with-border"><h3 class="box-title"><i class="fa fa-archive" aria-hidden="true"></i> Archived IPD: Bed occupied report</h3></div>
            <div class="box-body">
                <?php echo $top_form; ?>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        var patient_table = $('#patient_table').DataTable({
            ...
            'ordering': false,
            'ajax': {
                'url': base_url + 'archive/Ipd/get_bed_patients_list',
                'type': 'POST',
                'dataType': 'json',
                'data': function (d) {
                    return $.extend({}, d, {
