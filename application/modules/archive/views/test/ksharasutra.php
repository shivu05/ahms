<div class="row">
    <div class="col-md-12">
        <div class="box box-primary">
            <div class="box-header with-border"><h3 class="box-title"><i class="fa fa-list"></i> Archived Ksharasutra report:</h3>
    ...
    $(document).ready(function () {
        ...
        function show_patients() {
            patient_table = $('#patient_table').DataTable({
                ...
                'ordering': false,
                'ajax': {
                    'url': base_url + 'archive/Test/get_ksharasutra_report',
                    'type': 'POST',
                    'dataType': 'json',
                    'data': function (d) {
                        return $.extend({}, d, {
