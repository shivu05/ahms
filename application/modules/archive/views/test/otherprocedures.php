<div class="row">
    <div class="col-md-12">
        <div class="box box-primary">
            <div class="box-header with-border"><h3 class="box-title"><i class="fa fa-archive"></i> Archived Other Procedures report:</h3>
    ...
    $(document).ready(function () {
        ...
        $('#search_form').on('click', '#search', function () {
            ...
            if ($('#search_form').valid()) {
                $.ajax({
                    url: base_url + 'archive/test/fetch_oherprocedures_records',
                    type: 'POST',
                    data: form_data,
