<div class="row">
    <div class="col-md-12">
        <div class="box box-primary">
            <div class="box-header with-border"><h3 class="box-title"><i class="fa fa-photo"></i>Archived X-Ray report:</h3>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        var patient_table = $('#patient_table').DataTable({
            ...
            'ordering': false,
            'ajax': {
                'url': base_url + 'archive/Test/get_xray_patients_list',
                'type': 'POST',
                'dataType': 'json',
                'data': function (d) {
                    return $.extend({}, d, {
        ...
        $('#xray_modal_box').on('click', '#btn-update', function () {
            if ($('#xray_form').valid()) {
                ...
                $.ajax({
                    url: base_url + 'archive/Test/update_xray',
                    type: 'POST',
                    dataType: 'json',
                    data: form_data,
        ...
        $('#search_form').on('click', '#btn_delete', function () {
            ...
            if (num == 0) {
                ...
                if (confirm('Are you sure want to delete?')) {
                    ...
                    $.ajax({
                        url: base_url + 'archive/Test/delete_records',
                        type: 'POST',
                        data: form_data,
                        dataType: 'json',
                        success: function (res) {
