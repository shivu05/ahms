    ...
    <div class="col-md-12">
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title"><i class="fa fa-archive"></i> Archived IPD patients List:</h3>
                <a href="<?= base_url('archive/Ipd'); ?>"><button class="btn btn-sm btn-primary pull-right"><i class="fa fa-backward"></i> Back</button></a>
            </div>
            <div class="box-body">
                <?php
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $('#search_form #export').on('click', '#export_to_xls', function (e) {
            ...
            $.ajax({
                url: base_url + 'archive/patient/export_patients_list',
                type: 'POST',
                dataType: 'json',
        ...
        var patient_table = $('#patient_table').DataTable({
            ...
            'serverSide': true,
            'ajax': {
                'url': base_url + 'archive/patient/get_ipd_patients_list',
                'type': 'POST',
                'dataType': 'json',
                'data': function (d) {
                    return $.extend({}, d, {
        ...
        $('#patient_table tbody').on('click', '.download_case_sheet', function () {
            ...
            window.open(base_url + 'archive/patient/print_ipd_case_sheet/' + ipd + '/' + date, '_blank');
