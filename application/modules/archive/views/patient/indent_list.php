    ...
    $(document).ready(function () {
        ...
        var columns = [
            ...
            },
            {
                title: "Indent",
                data: function (item) {
                    return '<button class="btn btn-warning add_indent" data-doctor_name="' + item.Doctor + '" data-doa="' + item.DoAdmission + '" data-ipd_id=' + item.IpNo + '>Indent</button>';
                }
            }
        ];
        ...
        var patient_table = $('#patient_table').DataTable({
            ...
            'serverSide': true,
            'ajax': {
                'url': base_url + 'patient/patient/get_indent_patients',
                'type': 'POST',
                'dataType': 'json',
                'data': function (d) {
                    return $.extend({}, d, {
