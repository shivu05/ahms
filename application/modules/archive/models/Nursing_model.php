...
class Nursing_model extends CI_Model {
    ...
    function get_xray_data($db, $conditions, $export_flag = false) {
        ...
        $return['total_rows'] = $db->query('SELECT * FROM xrayregistery x JOIN treatmentdata t WHERE x.OpdNo=t.OpdNo')->num_rows();
        return $return;
    }
    ...
    function get_usg_data($db, $conditions, $export_flag = false) {
        ...
        $return['data'] = $result->result_array();
        $return['found_rows'] = $db->query($query)->num_rows();
        $return['total_rows'] = $db->query('SELECT * FROM usgregistery u JOIN treatmentdata t WHERE u.treatId=t.ID')->num_rows();
        return $return;
    }

    function get_ecg_data($db, $conditions, $export_flag = false) {
        ...
        $return['data'] = $result->result_array();
        $return['found_rows'] = $db->query($query)->num_rows();
        $return['total_rows'] = $db->query('SELECT * FROM ecgregistery e JOIN treatmentdata t WHERE e.treatId=t.ID')->num_rows();
        return $return;
    }
...
//b.OpdNo,b.deliveryDetail,b.babyBirthDate,b.birthtime,b.treatby,b.babyWeight,b.deliverytype,i.IpNo,i.deptOpdNo,i.FName,i.Age,i.diagnosis
    ...
    function get_birth_data($db, $conditions, $export_flag = false) {
        ...
        $return['data'] = $result->result_array();
        $return['found_rows'] = $db->query($query)->num_rows();
        $return['total_rows'] = $db->query('SELECT * FROM birthregistery')->num_rows();
        return $return;
    }

    function get_diet_data($db, $conditions, $export_flag = false) {
    ...
    function get_ksharasutra_data($db, $conditions, $export_flag = false) {
        ...
        $return['data'] = $result->result_array();
        $return['found_rows'] = $db->query($query)->num_rows();
        $return['total_rows'] = $db->query('SELECT k.OpdNo FROM ksharsutraregistery k JOIN treatmentdata t WHERE k.treatId=t.ID ')->num_rows();
        return $return;
    }

    function get_surgery_data($db, $conditions, $export_flag = false) {
        $return = array();
        ...
        $return['data'] = $result->result_array();
        $return['found_rows'] = $db->query($query)->num_rows();
        $return['total_rows'] = $db->query('SELECT * FROM surgeryregistery s JOIN patientdata p JOIN ipdtreatment t JOIN inpatientdetails i WHERE s.OpdNo = p.OpdNo AND s.treatId = t.ID AND s.OpdNo=i.OpdNo')->num_rows();
        return $return;
    }

    function get_panchakarma_data($db, $conditions, $export_flag = false) {
        $return = array();
        ...
        $return['data'] = $result->result_array();
        $return['found_rows'] = $db->query($query)->num_rows();
        $return['total_rows'] = $db->query('SELECT * FROM panchaprocedure l JOIN treatmentdata t ON l.treatid = t.ID JOIN patientdata p ON t.OpdNo = p.OpdNo')->num_rows();
        return $return;
    }

    function get_panchakarma_procedure_count($db, $conditions, $export_flag = false) {
    ...
    function get_surgery_count($db, $conditions, $export_flag = false) {
    ...
    function get_lab_report($db, $conditions, $export_flag = false) {
    ...
    function get_lab_report_count($db, $conditions, $export_flag = false) {
