...
class Ipd extends SHV_Controller {
    ...
    public function __construct() {
        ...
        $this->load->model('archive/ipd_model');
    }
    ...
    function index() {
        ...
        $data = array();
        $data['top_form'] = modules::run('common_methods/common_methods/date_dept_selection_form', 'archive/Ipd/export_to_pdf', false, false, true);
    ...
    function get_patients_list() {
        ...
        $data = $this->ipd_model->get_ipd_patients($db, $input_array);
        $return = $this->ipd_model->get_ipd_patients_count($db, $input_array);
    ...
    function export_to_pdf() {
        ...
        $html = $this->layout->render(array('view' => 'archive/ipd/export_ipd'), true);
        ...
        generate_pdf($html, 'L', $title, 'IPD_REPORT_' . $input_array['start_date'] . '', TRUE, TRUE, 'I');
        exit;
    }
