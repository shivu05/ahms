                ...
                <div class="col-4">
                    ...
                    <form class="form-horizontal" id="user_form" name="user_form" action="<?php echo base_url('master/users/save'); ?>" method="POST">
                        ...
                        <div class="tile-footer">
                            <button class="btn btn-primary" type="button" name="register_btn" id="register_btn"><i class="fa fa-fw fa-lg fa-check-circle"></i>Register</button>&nbsp;&nbsp;&nbsp;
                            <a class="btn btn-secondary" href="#" id="cancel_btn"><i class="fa fa-fw fa-lg fa-times-circle"></i>Cancel</a>
                        </div>
                    </form>
                </div>
            </div>
