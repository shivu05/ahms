<div class="row">
    <div class="col-md-12">
        <div class="box box-primary">
            <div class="box-header with-border"><h3 class="box-title"><i class="fa fa-photo"></i> Other procedures statistics:</h3></div>
            <div class="box-body">
                <?php echo $top_form; ?>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('#search_form').on('click', '#search', function () {
            ...
            $.ajax({
                url: base_url + 'reports/statistics/get_other_proc_stats',
                dataType: 'html',
                type: 'POST',
                data: form_data,
