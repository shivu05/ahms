-- =====================================================
-- PROFESSIONAL BILLING MODULE - DATABASE SCHEMA
-- Version: 1.0
-- Created: 2025
-- Purpose: Complete billing management system with insurance claims
-- =====================================================
...
-- Service Master (Medical/Surgical Services)
...
CREATE TABLE IF NOT EXISTS `billing_service_packages` (
...
-- Package Line Items
CREATE TABLE IF NOT EXISTS `billing_package_services` (
...
CREATE TABLE IF NOT EXISTS `billing_deposit_adjustments` (
...
CREATE TABLE IF NOT EXISTS `billing_insurance_companies` (
...
-- Insurance Policies
CREATE TABLE IF NOT EXISTS `billing_insurance_policies` (
...
CREATE TABLE IF NOT EXISTS `billing_insurance_preauth` (
...
CREATE TABLE IF NOT EXISTS `billing_claim_documents` (
...
CREATE TABLE IF NOT EXISTS `billing_claim_followups` (
...
CREATE TABLE IF NOT EXISTS `billing_tax_configurations` (
...
-- Insert Payment Methods (ignore duplicates)
...
-- Insert Service Categories (ignore duplicates)
...
-- Insert Billing Configurations (ignore duplicates)
...
-- Add foreign key for invoice to insurance policy (if not exists)
...
-- Add foreign key for invoice items to services (if not exists)
...
-- Add foreign key for insurance claims to preauth (if not exists)
...
-- Composite indexes for common queries (skip if already exist)
-- NOTE: Use FINAL_CLEAN_SETUP.sql for fresh install to avoid duplicate key errors
