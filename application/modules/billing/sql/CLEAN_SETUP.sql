-- =====================================================
-- BILLING MODULE - CLEAN SETUP SCRIPT
-- This script will DROP all existing billing tables and recreate them fresh
-- Use this to completely reset the billing module
-- =====================================================
...
-- Add foreign key for invoice to insurance policy (if not already exists)
...
-- Add foreign key for invoice items to services (if not already exists)
...
-- Add foreign key for insurance claims to preauth (if not already exists)
...
-- =====================================================
-- BILLING MODULE SETUP COMPLETE
-- =====================================================
-- Expected: 22 tables created
-- Run this query to verify: SHOW TABLES LIKE 'billing%';
-- =====================================================
