...
<div class="row">
    <div class="col-12">
        <div class="box box-primary">
            <div class="box-header with-border"><h3 class="box-title">Add IPD Bill:</h3></div>
            <div class="box-body">
    ...
    $(document).ready(function () {
        $('#patient_name').typeahead({
            source: function (query, process) {
                $.ajax({
                    url: "<?= base_url('common_methods/get_ipd_patients') ?>",
                    method: "POST",
                    data: {ipd: query},
                    dataType: "json",
                    success: function (data) {
                        ...
                        $.each(data, function (index, patient) {
                            const patientDisplay = `${patient.FirstName} - IPD: ${patient.IpNo} `;
                            patientNames.push(patientDisplay);
                            patientMap[patientDisplay] = patient.IpNo;
                        });
