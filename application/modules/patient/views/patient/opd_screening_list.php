    ...
    <div class="col-12">
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title"><i class="fa fa-list"></i> Patient master:</h3>
            </div>
            <div class="box-body">
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        var patient_table = $('#patient_table').DataTable({
            ...
            'serverSide': true,
            'ajax': {
                'url': base_url + 'patient/patient/get_patients_list_screening',
                'type': 'POST',
                'dataType': 'json',
                'data': function(d) {
                    return $.extend({}, d, {
        ...
        $('#default_modal_box .modal-footer').on('click', '#btn-ok', function() {
            ...
            if ($('#send_patient_for_followup').valid()) {
                ...
                $.ajax({
                    url: base_url + "patient/patient/followup_opd_screening",
                    type: 'POST',
                    data: form_data,
                    dataType: 'json',
                    success: function(res) {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (response.length > 0) {
                    ...
                    table += "<tr><td><b>Blood Pressure:</b></td><td><input type='text' name='blood_pressure' id='blood_pressure' class='form-control required'/></td></tr>";
                    table += "<tr><td><b>Pulse Rate:</b></td><td><input type='text' name='pulse_rate' id='pulse_rate' class='form-control required'/></td></tr>";
                    table += "<tr><td><b>Respiratory Rate:</b></td><td><input type='text' name='respiratory_rate' id='respiratory_rate' class='form-control required'/></td></tr>";
                    table += "<tr><td><b>Body Temperature:</b></td><td><input type='text' name='body_temperature' id='body_temperature' class='form-control required'/></td></tr>";
                    table += "<tr><td><b>Oxygen Saturation (SpO2):</b></td><td><input type='text' name='oxygen_saturation' id='oxygen_saturation' class='form-control required'/></td></tr>";
                    table += "<tr><td><b>Weight:</b></td><td><input type='text' name='weight' id='weight' class='form-control required'/></td></tr>";
                    ...
                    table += "<tr><td><b>Complaints:</b></td><td><textarea name='complaints' id='complaints' class='form-control required'></textarea></td></tr>";
