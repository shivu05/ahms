<div class="row">
    <div class="col-md-12">
        <div class="box box-primary">
            ...
            <div class="box-body">
                <form class="form-horizontal" name="patient_form" id="patient_form" method="POST">
                    <div class="row">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <div class="col-md-10">
                                    ...
                                    <input class="form-control required" id="age" name="age" type="number" min="1" max="120" aria-describedby="ageHelp" placeholder="Enter your age">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <div class="col-md-10">
                                    <label for="consultation_date">Consultation date: <span class="text-danger">*</span> </label>
