                                                ...
                                                <table class="table table-borderless" id="lab_cat_table">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <select name="lab_investigations[]" id="lab_investigations" multiple="multiple" class="lab_investigations form-control chosen-select" data-placeholder="Choose investigation"></select>
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                    <tfoot>
    ...
    $(document).ready(function () {
        ...
        $('#add_lab_row').on('click', function () {
            ...
            var markup = '<tr>' + '<td>' +
                    ...
                    '</td>' +
                    '<td>' +
                    '<select class="form-control lab_investigations chosen-select" multiple name="lab_investigations[]" id="lab_investigations_' + (n + 1) + '">' +
