...
<div class="row">
    <div class="col-md-12">
        <div class="box box-primary">
            ...
            <div class="box-body">
                <form class="form-horizontal" name="search_form" id="search_form" method="POST" target="_blank"
                    action="<?php echo base_url('patient/treatment/export'); ?>">
                    <div class="row">
                        <div class="col-md-1">
                            <label class="control-label sr-only">OPD</label>
                            <input class="form-control" type="text" placeholder="OPD" name="OpdNo" id="OpdNo"
                                autocomplete="off">
                        </div>
                        <div class="col-md-2">
                        ...
                        <div class="col-md-2">
                            ...
                            <input class="form-control date_picker" type="text" placeholder="Enter date" name="date"
                        ...
                        <div class="col-md-2">
                            <div class="form-check" style="padding-top: 5% !important">
                                <input class="form-check-input" type="checkbox" value="1" checked="checked"
                                    name="all_patients" id="all_patients">
                            ...
                            <div class="">
                                ...
                                <div class="btn-group" role="group" id="export">
                                    <button class="btn btn-info btn-sm" type="button"><i
                                            class="fa fa-fw fa-lg fa-upload"></i> Export</button>
                                ...
                                <button class="btn btn-success btn-sm" id="btnAdmit" type="button" disabled
                                    style="margin-left:8px;"><i class="fa fa-bed"></i> Admit</button>
                            </div>
                        </div>
                    </div>
                </form>
...
<div class="modal fade" id="treatment_edit_modal" data-backdrop="static" data-keyboard="false" tabindex="-1"
    role="dialog" aria-labelledby="treatment_edit_modal_title" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="treatment_edit_modal_title">Update patient information: <span id="OPD_NUM"
            ...
            <div class="modal-body" id="lab_modal_body">
                ...
                <form method="POST" name="treatment_edit_form" id="treatment_edit_form">
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" class="form-control required" id="pat_name" name="pat_name"
                                placeholder="Name" />
                        </div>
                    </div>
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="number" class="form-control required" id="pat_age" name="pat_age"
                                placeholder="Age" />
                        </div>
                    </div>
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <label class="radio-inline"><input class="form-check-input required" type="radio"
                                    name="pat_gender" id="pat_gender" value="Male">Male</label>
                            <label class="radio-inline"><input class="form-check-input required" type="radio"
                                    name="pat_gender" id="pat_gender" value="Female">Female</label>
                            <label class="radio-inline"><input class="form-check-input required" type="radio"
                                    name="pat_gender" id="pat_gender" value="others">Others</label>
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label" for="pat_diagnosis">Diagnosis:</label>
                        <div class="controls">
                            <input type="text" class="form-control required" id="pat_diagnosis" name="pat_diagnosis"
                                placeholder="Diagnisis" />
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <textarea name="pat_treatment" class="form-control required" id="pat_treatment" rows="3"
                                style="width: 100%" placeholder="Teatment should be seperated by comma"></textarea>
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label" for="pat_procedure">Procedures:</label>
                        <div class="controls">
                            <input type="text" class="form-control" id="pat_procedure" name="pat_procedure"
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="gridSystemModalLabel">Update treatment for <span style="color:#5A55A3"
                        id="treatment_modal_opdno"></span></h4>
            </div>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 bhoechie-tab-container">
                        ...
                        <div class="col-lg-9 col-md-9 col-sm-9 col-xs-9 bhoechie-tab">
                            ...
                            <div class="bhoechie-tab-content active">
                                ...
                                <div class="row">
                                    <h5 class="text-capitalize headline"
                                        style="padding-left: 15px !important;margin-top: 3px !important;font-size: larger;font-weight: bold;">
                                        PHYSIOTHERAPY
                                    </h5>
                                    <form class="form-horizontal" id="physiotherapy_form">
                                        <div class="form-group col-sm-10 col-md-10">
                                            <div class="checkbox">
                                                <label class="" style="padding-left:46px !important;">
                                                    <input type="checkbox" name="physiotherapy_check"
                                                        id="physiotherapy_check" />
                                                    Refer for PHYSIOTHERAPY
                                                </label>
                                            </div>
                                        </div>
                                        <div class="form-group col-sm-10 col-md-10">
                                            <label for="physic_name"
                                                class="col-md-4 col-sm-4 control-label pull-left required">Physiotherapy
                                                name:</label>
                                            <div class="col-md-6 col-sm-6">
                                                <select id="physic_name" name="physic_name"
                                                    class="form-control chosen-select physic_inputs"
                                                    required="required">
                                        ...
                                        <div class="form-group col-sm-10 col-md-10">
                                            <label for="start_date"
                                                class="col-md-4 col-sm-4 control-label required">Start date:</label>
                                            <div class="col-md-6 col-sm-6">
                                                <input id="physic_date" type="text" name="start_date"
                                                    class="form-control date_picker physic_inputs required"
                                                    placeholder="Enter Start date" autocomplete="off"
                                                    required="required">
                                            </div>
                                        </div>
                                        <div class="form-group col-sm-10 col-md-10">
                                            <label for="start_date" class="col-md-4 col-sm-4 control-label required">End
                                                date:</label>
                                            <div class="col-md-6 col-sm-6">
                                                <input id="physic_date" type="text" name="end_date"
                                                    class="form-control date_picker physic_inputs required"
                                                    placeholder="Enter End date" autocomplete="off" required="required">
                                            </div>
                                        </div>
                                        <div class="form-group col-sm-10 col-md-10">
                                            <label for="physic_doc"
                                                class="col-md-4 col-sm-4 control-label required">Physician name:</label>
                                            <div class="col-md-6 col-sm-6">
                                                <input id="physic_doc" type="text" name="physic_doc"
                                                    class="form-control physic_inputs required"
                                                    placeholder="Enter Doctor name" autocomplete="off"
                                                    required="required">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-md-offset-5 col-md-10" style="padding-left: 5% !important;">
                                                <button type="submit" name="submit" id="submit"
                                                    class="btn btn-primary btn-md physic_inputs"><i
                                                        class="fa fa-save"></i> Save</button>
                                                <button type="reset" name="reset" id="reset"
                                                    class="btn btn-danger btn-md physic_inputs"><i
                                ...
                                <div class="row">
                                    ...
                                    <form class="form-horizontal" id="otherprocedure_form">
                                        <div class="form-group col-sm-10 col-md-10">
                                            <div class="checkbox">
                                                <label class="" style="padding-left:46px !important;">
                                                    <input type="checkbox" name="other_proc_check"
                                                        id="other_proc_check" />
                                        ...
                                        <div class="form-group col-sm-10 col-md-10">
                                            <label for="other_proc_name required"
                                                class="col-md-4 col-sm-4 control-label pull-left required">Procedure
                                                name:</label>
                                            <div class="col-md-6 col-sm-6">
                                                <select id="other_proc_name" type="text" name="other_proc_name"
                                                    class="chosen-select form-control othr_proc_inputs"
                                                    required="required">
                                                    <option value="">Choose</option>
                                                    <?= $other_proc_markup ?>
                                                </select>
                                        ...
                                        <div class="form-group col-sm-10 col-md-10">
                                            <label for="other_start_date required"
                                                class="col-md-4 col-sm-4 control-label required">Start date:</label>
                                            <div class="col-md-6 col-sm-6">
                                                <input id="other_start_date" type="text" name="other_start_date"
                                                    class="form-control date_picker othr_proc_inputs"
                                                    placeholder="Enter Start date" autocomplete="off"
                                                    required="required">
                                            </div>
                                        </div>
                                        <div class="form-group col-sm-10 col-md-10">
                                            <label for="other_end_date required"
                                                class="col-md-4 col-sm-4 control-label required">End date:</label>
                                            <div class="col-md-6 col-sm-6">
                                                <input id="other_end_date" type="text" name="other_end_date"
                                                    class="form-control date_picker othr_proc_inputs"
                                                    placeholder="Enter End date" autocomplete="off" required="required">
                                            </div>
                                        </div>
                                        <div class="form-group col-sm-10 col-md-10">
                                            <label for="oth_proc_doc required"
                                                class="col-md-4 col-sm-4 control-label required">Physician name:</label>
                                            <div class="col-md-6 col-sm-6">
                                                <input id="oth_proc_doc" type="text" name="oth_proc_doc"
                                                    class="form-control othr_proc_inputs"
                                                    placeholder="Enter Doctor name" autocomplete="off"
                                                    required="required">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-md-offset-5 col-md-10" style="padding-left: 5% !important;">
                                                <button type="submit" name="submit" id="submit"
                                                    class="btn btn-primary btn-md othr_proc_inputs"><i
                                                        class="fa fa-save"></i> Save</button>
                                                <button type="reset" name="reset" id="reset"
                                                    class="btn btn-danger btn-md othr_proc_inputs"><i
                                                        class="fa fa-refresh"></i> Reset</button>
                                            </div>
                                        </div>
                                    </form>
                                ...
                                <div class="row">
                                    ...
                                    <form class="form-horizontal" id="kriyakalpa_form">
                                        <div class="form-group col-sm-10 col-md-10">
                                            <div class="checkbox">
                                                <label class="" style="padding-left:46px !important;">
                                                    <input type="checkbox" name="kriyakalpa_check"
                                                        id="kriyakalpa_check" />
                                        ...
                                        <div class="form-group col-sm-10 col-md-10">
                                            <label for="kriya_procedures required"
                                                class="col-md-4 col-sm-4 control-label required">Procedures:</label>
                                            <div class="col-md-6 col-sm-6">
                                                <textarea id="kriya_procedures" required type="text"
                                                    name="kriya_procedures" class="form-control kriya_inputs"
                                                    placeholder="Enter Procedures"></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group col-sm-10 col-md-10">
                                            <label for="kriya_start_date required"
                                                class="col-md-4 col-sm-4 control-label required">Date:</label>
                                            <div class="col-md-6 col-sm-6">
                                                <input id="kriya_start_date" required type="text"
                                                    name="kriya_start_date"
                                                    class="form-control date_picker kriya_inputs"
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-offset-5 col-md-10" style="padding-left: 5% !important;">
                                                <button type="submit" name="submit" id="submit"
                                                    class="btn btn-primary btn-md kriya_inputs"><i
                                                        class="fa fa-save"></i> Save</button>
                                                <button type="reset" name="reset" id="reset"
                                                    class="btn btn-danger btn-md kriya_inputs"><i
                                                        class="fa fa-refresh"></i> Reset</button>
                                            </div>
                                        </div>
                                    </form>
                            ...
                            <div class="bhoechie-tab-content">
                                <div class="row">
                                    ...
                                    <form class="form-horizontal" id="xray_form">
                                        ...
                                        <div class="form-group col-sm-10 col-md-10">
                                            <label for="partxray required"
                                                class="col-md-4 col-sm-4 control-label required">Part of X-Ray:</label>
                                            <div class="col-md-6 col-sm-6">
                                                <input id="partxray" type="text" name="partxray"
                                                    class="form-control xray_inputs" placeholder="Enter X-Ray Part"
                                                    autocomplete="off">
                                            </div>
                                        </div>
                                        <div class="form-group col-sm-10 col-md-10">
                                            <label for="xraydocname required"
                                                class="col-md-4 col-sm-4 control-label required">Referred Doctor
                                                Name:</label>
                                            <div class="col-md-6 col-sm-6">
                                                <input id="xraydocname" value="" type="text" name="xraydocname"
                                                    class="form-control xray_inputs" placeholder="Enter Doctor Name"
                                                    autocomplete="off">
                                            </div>
                                        </div>
                                        <div class="form-group col-sm-10 col-md-10">
                                            <label for="xraydate required"
                                                class="col-md-4 col-sm-4 control-label required">Referred date:</label>
                                            <div class="col-md-6 col-sm-6">
                                                <input id="xraydate" type="text" name="xraydate"
                                                    class="form-control date_picker xray_inputs"
                                                    placeholder="Enter referred date" autocomplete="off">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-md-offset-5 col-md-10" style="padding-left: 5% !important;">
                                                <button type="submit" name="submit" id="submit"
                                                    class="btn btn-primary btn-md xray_inputs"><i
                                                        class="fa fa-save"></i> Save</button>
                                                <button type="reset" name="reset" id="reset"
                                                    class="btn btn-danger btn-md xray_inputs"><i
                                                        class="fa fa-refresh"></i> Reset</button>
                                            </div>
                                        </div>
                                    </form>
                                ...
                                <div class="row">
                                    ...
                                    <form class="form-horizontal" id="swarnaprashana_form" name="swarnaprashana_form">
                                        <div class="form-group col-sm-10 col-md-10">
                                            <div class="checkbox">
                                                <label class="" style="padding-left:46px !important;">
                                                    <input type="checkbox" name="swarnaprashana_check"
                                                        id="swarnaprashana_check" />
                                                    Refer for Swarnaprashana
                                                </label>
                                            </div>
                                        </div>
                                        <div class="form-group col-sm-10 col-md-10">
                                            <label for="date_month required"
                                                class="col-md-4 col-sm-4 control-label required">Date and Month of
                                                Swarnaprashana:</label>
                                            <div class="col-md-6 col-sm-6">
                                                <input id="date_month" type="text" name="date_month"
                                                    class="form-control swarnaprashana_inputs date_picker required"
                                                    placeholder="Select date" autocomplete="off">
                                            </div>
                                        </div>
                                        <div class="form-group col-sm-10 col-md-10">
                                            <label for="dpse_time required"
                                                class="col-md-4 col-sm-4 control-label required">Time:</label>
                                            <div class="col-md-6 col-sm-6">
                                                <input id="dpse_time" type="time" name="dose_time"
                                                    class="form-control swarnaprashana_inputs required"
                                                    placeholder="Enter referred date" autocomplete="off">
                                            </div>
                                        </div>
                                        <div class="form-group col-sm-10 col-md-10">
                                            <label for="consultant required"
                                                class="col-md-4 col-sm-4 control-label required">Referred Doctor
                                                Name:</label>
                                            <div class="col-md-6 col-sm-6">
                                                <input id="consultant" value="" type="text" name="consultant"
                                                    class="form-control swarnaprashana_inputs required"
                                                    placeholder="Enter Doctor Name" autocomplete="off">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-md-offset-5 col-md-10" style="padding-left: 5% !important;">
                                                <button type="submit" name="submit" id="submit"
                                                    class="btn btn-primary btn-md swarnaprashana_inputs"><i
                                                        class="fa fa-save"></i> Save</button>
                                                <button type="reset" name="reset" id="reset"
                                                    class="btn btn-danger btn-md swarnaprashana_inputs"><i
                                                        class="fa fa-refresh"></i> Reset</button>
                                            </div>
                                        </div>
                                    </form>
                                ...
                                <div class="row">
                                    ...
                                    <form class="form-horizontal" id="agnikarma_form" name="agnikarma_form">
                                        <div class="form-group col-sm-10 col-md-10">
                                            <div class="checkbox">
                                                <label class="" style="padding-left:46px !important;">
                                                    <input type="checkbox" name="agnikarma_check"
                                                        id="agnikarma_check" />
                                                    Refer for Agnikarma
                                                </label>
                                            </div>
                                        ...
                                        <div class="form-group col-sm-10 col-md-10">
                                            <label for="ref_date required"
                                                class="col-md-4 col-sm-4 control-label required">Date:</label>
                                            <div class="col-md-6 col-sm-6">
                                                <input id="ref_date" type="text" required="required" name="ref_date"
                                                    class="form-control agnikarma_inputs date_picker required"
                                                    placeholder="Select date" autocomplete="off">
                                            </div>
                                        </div>
                                        <div class="form-group col-sm-10 col-md-10">
                                            <label for="doctor_name required"
                                                class="col-md-4 col-sm-4 control-label required">Doctor Name:</label>
                                            <div class="col-md-6 col-sm-6">
                                                <input id="doctor_name" value="" required="required" type="text"
                                                    name="doctor_name" class="form-control agnikarma_inputs required"
                                                    placeholder="Enter Doctor Name" autocomplete="off">
                                            </div>
                                        </div>
                                        <div class="form-group col-sm-10 col-md-10">
                                            <label for="treatment_notes" class="col-md-4 col-sm-4 control-label">Medical
                                                Notes: (Optional)</label>
                                            <div class="col-md-6 col-sm-6">
                                                <textarea id="treatment_notes" value="" type="text"
                                                    name="treatment_notes" class="form-control agnikarma_inputs"
                                                    placeholder="Enter Medical notes" autocomplete="off"></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-md-offset-5 col-md-10" style="padding-left: 5% !important;">
                                                <button type="submit" name="submit" id="submit"
                                                    class="btn btn-primary btn-md agnikarma_inputs"><i
                                                        class="fa fa-save"></i> Save</button>
                                                <button type="reset" name="reset" id="reset"
                                                    class="btn btn-danger btn-md agnikarma_inputs"><i
                                                        class="fa fa-refresh"></i> Reset</button>
                                            </div>
                                        </div>
                                    </form>
                                ...
                                <div class="row">
                                    ...
                                    <form class="form-horizontal" id="cupping_form" name="cupping_form">
                                        ...
                                        <div class="form-group col-sm-10 col-md-10">
                                            ...
                                            <div class="col-md-6 col-sm-6">
                                                <input id="ref_date" type="text" required="required" name="ref_date"
                                                    class="form-control cupping_inputs date_picker required"
                                                    placeholder="Select date" autocomplete="off">
                                            </div>
                                        </div>
                                        <div class="form-group col-sm-10 col-md-10">
                                            ...
                                            <div class="col-md-6 col-sm-6">
                                                <input id="doctor_name" value="" required="required" type="text"
                                                    name="doctor_name" class="form-control cupping_inputs required"
                                                    placeholder="Enter Doctor Name" autocomplete="off">
                                            </div>
                                        </div>
                                        <div class="form-group col-sm-10 col-md-10">
                                            <label for="type_of_cupping"
                                                class="col-md-4 col-sm-4 control-label required">Type of
                                                Cupping:</label>
                                            <div class="col-md-6 col-sm-6">
                                                <select id="type_of_cupping" name="type_of_cupping"
                                                    class="form-control cupping_inputs required">
                                                    <option value="">Choose</option>
                                        ...
                                        <div class="form-group col-sm-10 col-md-10">
                                            <label for="site_of_application"
                                                class="col-md-4 col-sm-4 control-label required">Site of
                                                Application:</label>
                                            <div class="col-md-6 col-sm-6">
                                                <input id="site_of_application" value="" required="required" type="text"
                                                    name="site_of_application"
                                                    class="form-control cupping_inputs required"
                                                    placeholder="Enter Site of Application" autocomplete="off">
                                            </div>
                                        </div>
                                        <div class="form-group col-sm-10 col-md-10">
                                            <label for="no_of_cups_used"
                                                class="col-md-4 col-sm-4 control-label required">Number of Cups
                                                Used:</label>
                                            <div class="col-md-6 col-sm-6">
                                                <input id="no_of_cups_used" value="" required="required" type="number"
                                                    name="no_of_cups_used" class="form-control cupping_inputs required"
                                                    placeholder="Enter Number of Cups Used" autocomplete="off">
                                            </div>
                                        </div>
                                        <div class="form-group col-sm-10 col-md-10">
                                            <label for="treatment_notes" class="col-md-4 col-sm-4 control-label">Medical
                                            ...
                                            <div class="col-md-6 col-sm-6">
                                                <textarea id="treatment_notes" value="" type="text"
                                                    name="treatment_notes" class="form-control cupping_inputs"
                                                    placeholder="Enter Medical notes" autocomplete="off"></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-md-offset-5 col-md-10" style="padding-left: 5% !important;">
                                                <button type="submit" name="submit" id="submit"
                                                    class="btn btn-primary btn-md cupping_inputs"><i
                                                        class="fa fa-save"></i> Save</button>
                                                <button type="reset" name="reset" id="reset"
                                                    class="btn btn-danger btn-md cupping_inputs"><i
                                                        class="fa fa-refresh"></i> Reset</button>
                                            </div>
                                        </div>
                                    </form>
                            ...
                            <div class="bhoechie-tab-content">
                                <div class="row">
                                    ...
                                    <form class="form-horizontal" id="jaloukavacharana_form"
                                        name="jaloukavacharana_form">
                                        <div class="form-group col-sm-10 col-md-10">
                                            <div class="checkbox">
                                                <label class="" style="padding-left:46px !important;">
                                                    <input type="checkbox" name="jaloukavacharana_check"
                                                        id="jaloukavacharana_check" />
                                        ...
                                        <div class="form-group col-sm-10 col-md-10">
                                            ...
                                            <div class="col-md-6 col-sm-6">
                                                <input id="ref_date" type="text" required="required" name="ref_date"
                                                    class="form-control jaloukavacharana_inputs date_picker required"
                                                    placeholder="Select date" autocomplete="off">
                                            </div>
                                        </div>
                                        <div class="form-group col-sm-10 col-md-10">
                                            ...
                                            <div class="col-md-6 col-sm-6">
                                                <input id="doctor_name" value="" required="required" type="text"
                                                    name="doctor_name"
                                                    class="form-control jaloukavacharana_inputs required"
                                                    placeholder="Enter Doctor Name" autocomplete="off">
                                            </div>
                                        </div>
                                        <div class="form-group col-sm-10 col-md-10">
                                            <label for="procedure_details"
                                                class="col-md-4 col-sm-4 control-label required">Procedure
                                                Details:</label>
                                            <div class="col-md-6 col-sm-6">
                                                <textarea id="procedure_details" value="" type="text"
                                                    name="procedure_details"
                                                    class="form-control jaloukavacharana_inputs required"
                                                    placeholder="Enter Procedure Details" autocomplete="off"></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group col-sm-10 col-md-10">
                                            <label for="doctor_remarks" class="col-md-4 col-sm-4 control-label">Doctor
                                                Remarks:</label>
                                            <div class="col-md-6 col-sm-6">
                                                <textarea id="doctor_remarks" value="" type="text" name="doctor_remarks"
                                                    class="form-control jaloukavacharana_inputs"
                                                    placeholder="Enter Doctor Remarks" autocomplete="off"></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-md-offset-5 col-md-10" style="padding-left: 5% !important;">
                                                <button type="submit" name="submit" id="submit"
                                                    class="btn btn-primary btn-md jaloukavacharana_inputs"><i
                                                        class="fa fa-save"></i> Save</button>
                                                <button type="reset" name="reset" id="reset"
                                                    class="btn btn-danger btn-md jaloukavacharana_inputs"><i
                                                        class="fa fa-refresh"></i> Reset</button>
                                            </div>
                                        </div>
                                    </form>
                                ...
                                <div class="row">
                                    ...
                                    <form class="form-horizontal" id="siravyadana_form" name="siravyadana_form">
                                        <div class="form-group col-sm-10 col-md-10">
                                            <div class="checkbox">
                                                <label class="" style="padding-left:46px !important;">
                                                    <input type="checkbox" name="siravyadana_check"
                                                        id="siravyadana_check" />
                                        ...
                                        <div class="form-group col-sm-10 col-md-10">
                                            ...
                                            <div class="col-md-6 col-sm-6">
                                                <input id="ref_date" type="text" required="required" name="ref_date"
                                                    class="form-control siravyadana_inputs date_picker required"
                                                    placeholder="Select date" autocomplete="off">
                                            </div>
                                        </div>
                                        <div class="form-group col-sm-10 col-md-10">
                                            ...
                                            <div class="col-md-6 col-sm-6">
                                                <input id="doctor_name" value="" required="required" type="text"
                                                    name="doctor_name" class="form-control siravyadana_inputs required"
                                                    placeholder="Enter Doctor Name" autocomplete="off">
                                            </div>
                                        </div>
                                        <div class="form-group col-sm-10 col-md-10">
                                            ...
                                            <div class="col-md-6 col-sm-6">
                                                <textarea id="procedure_details" value="" type="text"
                                                    name="procedure_details"
                                                    class="form-control siravyadana_inputs required"
                                                    placeholder="Enter Procedure Details" autocomplete="off"></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group col-sm-10 col-md-10">
                                            ...
                                            <div class="col-md-6 col-sm-6">
                                                <textarea id="doctor_remarks" value="" type="text" name="doctor_remarks"
                                                    class="form-control siravyadana_inputs"
                                                    placeholder="Enter Doctor Remarks" autocomplete="off"></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-md-offset-5 col-md-10" style="padding-left: 5% !important;">
                                                <button type="submit" name="submit" id="submit"
                                                    class="btn btn-primary btn-md siravyadana_inputs"><i
                                                        class="fa fa-save"></i> Save</button>
                                                <button type="reset" name="reset" id="reset"
                                                    class="btn btn-danger btn-md siravyadana_inputs"><i
                                                        class="fa fa-refresh"></i> Reset</button>
                                            </div>
                                        </div>
                                    </form>
                                ...
                                <div class="row">
                                    ...
                                    <form class="form-horizontal" id="wound_dressing_form" name="wound_dressing_form">
                                        <div class="form-group col-sm-10 col-md-10">
                                            <div class="checkbox">
                                                <label class="" style="padding-left:46px !important;">
                                                    <input type="checkbox" name="wound_dressing_check"
                                                        id="wound_dressing_check" />
                                        ...
                                        <div class="form-group col-sm-10 col-md-10">
                                            ...
                                            <div class="col-md-6 col-sm-6">
                                                <input id="ref_date" type="text" required="required" name="ref_date"
                                                    class="form-control wound_dressing_inputs date_picker required"
                                                    placeholder="Select date" autocomplete="off">
                                            </div>
                                        </div>
                                        <div class="form-group col-sm-10 col-md-10">
                                            <label for="wound_location"
                                                class="col-md-4 col-sm-4 control-label required">Wound Location:</label>
                                            <div class="col-md-6 col-sm-6">
                                                <input id="wound_location" value="" required="required" type="text"
                                                    name="wound_location"
                                                    class="form-control wound_dressing_inputs required"
                                                    placeholder="Enter Wound Location" autocomplete="off">
                                            </div>
                                        </div>
                                        <div class="form-group col-sm-10 col-md-10">
                                            <label for="wound_type"
                                                class="col-md-4 col-sm-4 control-label required">Wound Type:</label>
                                            <div class="col-md-6 col-sm-6">
                                                <input id="wound_type" value="" required="required" type="text"
                                                    name="wound_type"
                                                    class="form-control wound_dressing_inputs required"
                                                    placeholder="Enter Wound Type" autocomplete="off">
                                            </div>
                                        </div>
                                        <div class="form-group col-sm-10 col-md-10">
                                            <label for="dressing_material"
                                                class="col-md-4 col-sm-4 control-label required">Dressing
                                                Material:</label>
                                            <div class="col-md-6 col-sm-6">
                                                <textarea id="dressing_material" value="" type="text"
                                                    name="dressing_material"
                                                    class="form-control wound_dressing_inputs required"
                                                    placeholder="Enter Dressing Material" autocomplete="off"></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group col-sm-10 col-md-10">
                                            <label for="doctor_name"
                                        ...
                                        <div class="form-group col-sm-10 col-md-10">
                                            <label for="next_dressing_date" class="col-md-4 col-sm-4 control-label">Next
                                                Dressing Date:</label>
                                            <div class="col-md-6 col-sm-6">
                                                <input id="next_dressing_date" value="" type="text"
                                                    name="next_dressing_date"
                                                    class="form-control wound_dressing_inputs date_picker"
                                                    placeholder="Select Next Dressing Date" autocomplete="off">
                                            </div>
                                        </div>
                                        <div class="form-group col-sm-10 col-md-10">
                                            <label for="doctor_remarks" class="col-md-4 col-sm-4 control-label">Doctor
                                            ...
                                            <div class="col-md-6 col-sm-6">
                                                <textarea id="doctor_remarks" value="" type="text" name="doctor_remarks"
                                                    class="form-control wound_dressing_inputs"
                                                    placeholder="Enter Doctor Remarks" autocomplete="off"></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-md-offset-5 col-md-10" style="padding-left: 5% !important;">
                                                <button type="submit" name="submit" id="submit"
                                                    class="btn btn-primary btn-md wound_dressing_inputs"><i
                                                        class="fa fa-save"></i> Save</button>
                                                <button type="reset" name="reset" id="reset"
                                                    class="btn btn-danger btn-md wound_dressing_inputs"><i
                                                        class="fa fa-refresh"></i> Reset</button>
                                            </div>
                                        </div>
                                    </form>
...
<div class="modal fade" id="admitModal" tabindex="-1" role="dialog" aria-labelledby="admitModalLabel"
    aria-hidden="true">
    <div class="modal-dialog" role="document">
        <form id="admitForm" autocomplete="off">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="admitModalLabel">Admit Patients</h4>
                </div>
                <div class="modal-body">
                    <div class="form-group" id="admissionDateGroup">
                        <label for="admission_date" class="control-label">Admission date</label>
                        <input type="text" class="form-control date_picker" id="admission_date" name="admission_date"
                            required aria-required="true" aria-describedby="admissionDateHelp">
                        <span class="help-block" id="admissionDateHelp" style="display:none;color:#a94442;"></span>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
                    <button type="submit" class="btn btn-primary" id="submitAdmit">Submit</button>
                </div>
            </div>
        </form>
    </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        function updateAdmitButtonState() {
            var anyChecked = $('#patient_table tbody .row-check:checked').length > 0;
            $('#btnAdmit').prop('disabled', !anyChecked);
            if (anyChecked) {
                $('#btnAdmit').removeClass('disabled');
            } else {
                $('#btnAdmit').addClass('disabled');
            }
        }
        ...
        var columns = [
            {
                title: '<input type="checkbox" id="selectAll" aria-label="Select all patients">',
                class: "text_center",
                orderable: false,
                data: function (item) {
                    return '<input type="checkbox" class="row-check" value="' + item.OpdNo + '" aria-label="Select patient ' + item.OpdNo + '">';
                }
            }, {
                title: "OPD",
                class: "opd_no",
        ...
        $('#patient_table').on('change', '#selectAll', function () {
            ...
            $('#patient_table tbody .row-check').prop('checked', checked);
            updateAdmitButtonState();
        });
        $('#patient_table tbody').on('change', '.row-check', function () {
            var all = $('#patient_table tbody .row-check').length;
            var checked = $('#patient_table tbody .row-check:checked').length;
        ...
        $('#btnAdmit').on('click', function () {
            var selected = getSelectedOpds();
            if (selected.length === 0) {
                showAlert('Please select at least one patient.', 'warning');
                return;
            }
            $('#admitForm')[0].reset();
            $('#admissionDateHelp').hide();
            $('#admitModal').modal('show');
            setTimeout(function () { $('#admission_date').focus(); }, 400);
        });

        // --- Get selected OPD numbers ---
        function getSelectedOpds() {
            var opds = [];
            $('#patient_table tbody .row-check:checked').each(function () {
                opds.push($(this).val());
            });
            return opds;
        }
        ...
        $('#admitForm').on('submit', function (e) {
            ...
            if (!admission_date) {
                $('#admissionDateHelp').text('Admission date is required.').show();
                $('#admission_date').focus();
                return;
            } else {
                $('#admissionDateHelp').hide();
            }
            var opds = getSelectedOpds();
            var payload = {
                opd_nos: opds,
            ...
            var tokenValue = $('meta[name="csrf-token-value"]').attr('content');
            //payload[tokenName] = tokenValue;

            $('#submitAdmit').prop('disabled', true);
            var form_data = $('#admitForm').serializeArray();
            $.ajax({
                url: base_url + 'patient/admit_patient',
                type: 'POST',
                data: payload,
                dataType: 'json',
                success: function (res) {
                    $('#submitAdmit').prop('disabled', false);
                    if (res.ok) {
                        $('#admitModal').modal('hide');
                        showAlert(res.message, 'success');
                        patient_table.ajax.reload(null, false);
                    } else {
                        showAlert(res.message || 'Admission failed.', 'danger');
                    }
                },
                error: function (xhr) {
                    $('#submitAdmit').prop('disabled', false);
                    var msg = 'Admission failed.';
