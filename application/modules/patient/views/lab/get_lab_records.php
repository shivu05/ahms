...
if (!empty($records)) {
    $table = "<table class='table table-bordered'><thead><tr><th>Category</th><th>Test</th><th>Investigation</th><th>Diagnosis</th><th>Test value</th><th>Test range</th></tr></thead>";
    $table .= "<tbody>";
    foreach ($records as $row) {
        ...
        $table .= '<td><input type="hidden" name="lab_id[]" id="lab_id" value="' . $row['lab_id'] . '"/><input class="form-control" id="test_value" name="test_value[]" type="text" aria-describedby="test_dateHelp" placeholder="Enter Test value"></td>';
